...
from cospy.plugins.mri.reconstruct.linear import Wavelet2
from cospy.plugins.mri.reconstruct.reconstruct import FFT2
from cospy.plugins.mri.parallel_mri.utils import prod_over_maps
from cospy.plugins.mri.parallel_mri.utils import function_over_maps
from cospy.plugins.mri.parallel_mri.reconstruct import sparse_rec_fista
from cospy.plugins.mri.parallel_mri.reconstruct import sparse_rec_condatvu
from cospy.plugins.mri.reconstruct.utils import convert_mask_to_locations
from cospy.plugins.mri.parallel_mri.gradient import Grad2D_pMRI
# from cospy.plugins.mri.parallel_mri.gradient import Grad2D_pMRI_synthesis
from cospy.plugins.mri.parallel_mri.extract_sensitivity_maps import get_Smaps
...
# mask.show()
image = cospy.Image(data=np.abs(SOS), metadata=mask.metadata)
image.show()
