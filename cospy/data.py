...
# Package import
import cospy
from cospy.base.exceptions import Exception
...
DATADIR = os.path.join(os.path.expanduser("~"), ".local", "share", "cospy")
PACKAGEDIR = os.path.dirname(cospy.__file__)
...
def get_sample_data(dataset_name, datadir=DATADIR, verbose=1):
    ...
    '$HOME/.local/share/cospy' directory.
    ...
    dataset["url"] = dataset["url"].format(**{"COSPY": PACKAGEDIR})
