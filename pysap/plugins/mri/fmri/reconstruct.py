...
def sparse_rec_fista(data, wavelet_name, samples, mu, wavelet_name_t=None, nb_scales=4,
                     nb_scale_t=3, lambda_init=1.0, max_nb_of_iter=300, atol=1e-4,
...
def sparse_rec_condatvu(data, wavelet_name, samples, wavelet_name_t=None,
                        nb_scales=4, nb_scale_t=3,
